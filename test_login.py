...
class LoginTests(unittest.TestCase):
    ...
    def setUp(self):
        app = ('/Users/samaythakkar/Library/Developer/Xcode/DerivedData/AppiumTest-cukxwffpssnbzpembufrsplwpudt/Build/Products/Debug-iphonesimulator/AppiumTest.app')
